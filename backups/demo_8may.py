...
class Environment(object):
    ...
    def fetch_question(self,id =None, qtype= 'simple'):
        ...
        return input_questions, entities_in_questions, types_in_questions, relations_in_questions, ints_in_questions, id, train_batch_dict[-1][-1]['results']['per_step_programs'], train_batch_dict[-1][-1]['results']['reward']
